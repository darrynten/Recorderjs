...
Resampler.prototype.compileLinearInterpolationFunction = function () {
  console.log('compile');
	...
	var outLength = this.outputBufferSize; console.log(this.outputBufferSize, bufferLength, this.channels);\
